...
public class ExtentReportUtility implements ITestListener {
	...
	public void configureReport() {
		...
		// System details
		reports.setSystemInfo("PC Name", "Pooja");
	...
	public void onTestFailure(ITestResult result) {    //test failure
		test = reports.createTest(result.getName());
	...
	public void onStart(ITestContext context) {   //before everything starts control comes here
		configureReport();
	}

	public void onFinish(ITestContext context) {   //after every execution
		reports.flush();                           //final output generated by flush method
	}
